...
public class PruebasController {
    ...
    @PostMapping("/query1")
    public String consultaQuery1(@RequestParam(value = "precioMin") double precioMin,
            @RequestParam(value = "precioMax") double precioMax, Model model) {
        var productos = productoService.findByPrecioBetweenOrderByDescripcion(precioMin, precioMax);
        model.addAttribute("productos", productos);
